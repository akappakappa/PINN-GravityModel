function [data, split] = PINN_GM_III(data, splitPercentage)
    ...
    function data = pMakeValidationSet(data, splitPercentage)
        ...
        pSurfaceDiv = floor(size(data.tSurfaceTRJ, 1) * splitPercentage);
        pRandomDiv  = floor(size(data.tRandomTRJ, 1)  * splitPercentage);
