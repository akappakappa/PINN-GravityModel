function net = PINN_GM_III(mu, e)
    ...
    layersFeatureEngineering = [ ...
        ...
        presets.network.customLayer.cart2sphLayer( ...
    ...
    net = addLayers(net, presets.network.customLayer.scaleNNPotentialLayer( ...
        "Name", "scaleNNPotentialLayer"       , "InputNames", ["Potential", "Radius"]        , "OutputName", "Potential" ...
    ));
    net = addLayers(net, presets.network.customLayer.analyticModelLayer("mu", mu, ...
        "Name", "analyticModelLayer"          , "InputName" , "Radius"                       , "OutputName", "Potential" ...
    ));
    net = addLayers(net, presets.network.customLayer.fuseModelsLayer("e", e, ...
        "Name", "fuseModelsLayer"             , "InputNames", ["PotNN", "PotLF", "Radius"]   , "OutputName", "Potential" ...
    ));
    net = addLayers(net, presets.network.customLayer.applyBoundaryConditionsLayer( ...
