function net = Residual_XXS(params)
    net = dlnetwork();
    ...
    net = connectLayers(net, "cart2sphLayer/Spherical", "fc0"          );
    net = connectLayers(net, "act0"                   , "addRBFto3/in2");
