...
ds.train  = shuffle(combine( ...
    arrayDatastore(table2array(readall(datastore("src/preprocessing/datastore/train/Trj.csv")))), ...
    arrayDatastore(table2array(readall(datastore("src/preprocessing/datastore/train/Acc.csv")))), ...
    arrayDatastore(table2array(readall(datastore("src/preprocessing/datastore/train/Pot.csv")))) ...
));
ds.validation = shuffle(combine( ...
    arrayDatastore(table2array(readall(datastore("src/preprocessing/datastore/validation/Trj.csv")))), ...
    arrayDatastore(table2array(readall(datastore("src/preprocessing/datastore/validation/Acc.csv")))), ...
    arrayDatastore(table2array(readall(datastore("src/preprocessing/datastore/validation/Pot.csv")))) ...
));
ds.test = shuffle(combine( ...
    arrayDatastore(table2array(readall(datastore("src/preprocessing/datastore/test/Trj.csv")))), ...
    arrayDatastore(table2array(readall(datastore("src/preprocessing/datastore/test/Acc.csv")))), ...
    arrayDatastore(table2array(readall(datastore("src/preprocessing/datastore/test/Pot.csv")))) ...
));
